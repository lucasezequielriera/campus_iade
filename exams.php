...
if (isset($_POST['id_course'])) {
    $aux = $db->escape($db->escapeWildcards($_POST['id_course']));
    $db->query("SELECT exams FROM curso WHERE id_curso = $aux LIMIT 1");
    $exam = $db->fetchAll();
    //$exam[0]['exams'];
    $exam = $exam[0]['exams']. "exams.txt";
    ...
    <div class="container my-3">
        <form action="" method="post" name="form_course">
            <div class="row">
                <div class="col-6 p-0 mb-2">
                    <select id="course" name="id_course" class="form-control" required>
                        <option hidden disabled selected>-- Seleccione curso --</option>
                        <?php
        ...
        ?>
                                    ...
                                    <tbody id="body_mods">
                                        ...
                                        for ($i = 2; $i < 8; $i++) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><a title="Descargar Archivo" href="<?= $curso['url_doc'];
            ...
            <!--segundo row -->
        <?php } ?>
        <!-- If que muestra "Card" con info dle curso -->
    </div>
