  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <table class="table">
                  ...
                  <tbody>
                    <?php
                      $archivos = scandir($curso['url_doc'] . $archivos[$i]);
                      for ($i=2; $i<8; $i++) { ?>
                            <tr>
                                <td>
                                <button type="button" class="btn-sm btn-info open-modal" data-toggle="modal">
                                    <?php echo $archivos[$i];?>
                                </button>
                                </td>
                                ...
                                <td class="text-center"><a id="borrar" title="Eliminar Archivo" href="delete.php?name=<?php echo $curso['url_doc']; echo $archivos[$i];?>" style="color: red; font-size:18px;" onclick="return confirm('Esta seguro de eliminar el archivo?');"> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/></svg></a></td>
                            </tr>
                      <?php } ?> 
                  </tbody>
                </table>
