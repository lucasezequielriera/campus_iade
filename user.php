...
if ($_SESSION['mensaje'] != "") {
  ...
  $_SESSION['mensaje'] = ""; ?>
    ...
    <form class="container" id="form_user"action="admin.php" method="post"> <br> <br>
      <div class="form-row">
      ...
      <button class="btn btn-primary" onclick="stopDefAction(event);" id="btn_alta" name="btnAccion" value="newUser" type="submit">Dar de alta usuario</button>
    </form>
